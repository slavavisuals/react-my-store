        ...
        return (
            <>
                ...
                {sorted.length > 1 &&
                    ...
                    {/* prev */}
                        {page > 1 && <button className="prev-page-btn" onClick={() => changePage(page - 1)}><FaAngleDoubleLeft/></button>}
                    {sorted.map((_, index) => {
                        return (
                        <button
                ...
                {/*  next  */}
                        {page < sorted.length - 1 && <button className="next-page-btn" onClick={() => changePage(page + 1)}><FaAngleDoubleRight/></button>}
